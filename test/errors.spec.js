...
describe('bufferedAsyncMap() errors', () => {
  ...
  it('AC 1.1: should reject with the original error (identity preserved) when exactly one error is captured', async () => {
  ...
  it('AC 1.2: should reject with AggregateError containing all errors when 2+ errors are captured', async () => {
  ...
  it('AC 1.3: should include both source and callback errors in the AggregateError', async () => {
  ...
  it('AC 1.4: should resolve cleanly when no errors are captured (no regression)', async () => {
    /** @type {number[]} */
    const result = [];
  ...
  it('AC 1.5: should not retract values delivered before the throw', async () => {
